import { EvaluationDashboardResponse, PopulationDashboardResponse } from "../type"

export const dashboard: PopulationDashboardResponse = {
    data: {
        kpis: {
...
export const dasboardEvaluation: EvaluationDashboardResponse = {
    data: {
        kpis: {
            totalEvaluations: {
                absolute: 6582,
