...
import { EvaluationsByTypeTest } from "../type";
...
interface EvaluationsByTypeTestChartProps {
  data: EvaluationsByTypeTest[];
}

export function EvaluationsByTypeTestChart({
  data,
}: EvaluationsByTypeTestChartProps) {
  console.log("EvaluationsByTypeTestChart data:", data);
  if (!data) return null;
