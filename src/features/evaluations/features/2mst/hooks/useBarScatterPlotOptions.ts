...
export function useBarScatterPlotOptions({
  ...
  return useMemo(() => {
    ...
    // Cores para cada caixa do boxplot
        ...
        ? [
            {
              name: "Paciente",
              type: "scatter" as const,
              data: [[patientIdx, participantSteps]],
              symbolSize: 14,
              symbol: "diamond",
              itemStyle: {
                color: "#FF4444",
      ...
      tooltip: {
        ...
        formatter: (params: any) => {
          ...
          if (params.seriesName === "Paciente") {
            return `<strong>Paciente</strong><br/>Passos: ${participantSteps}`;
          }
          return "";
        },
      },
  ...
  }, [participantAge, participantSteps, participantGender, labelColor]);
}
