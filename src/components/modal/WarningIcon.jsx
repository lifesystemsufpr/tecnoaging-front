export default function WarningIcon({ className = 'w-20 h-20' }) {
    return (
        <div className={`relative flex items-center justify-center ${className}`}>
            {/* Círculo de fundo */}
            <svg
                className="fill-yellow-100 dark:fill-yellow-500/15"
                width="90"
                height="90"
                viewBox="0 0 90 90"
                fill="none"
            ...
            <span className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
                <svg
                    className="fill-yellow-500 dark:fill-orange-400"
                    width="38"
                    height="38"
                    viewBox="0 0 38 38"
                    fill="none"
