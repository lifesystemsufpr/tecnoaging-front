...
import { formatCPF, sanatizeCPF, sanatizePhone } from "@/core/utils";
import { HealthProfessional, Participant, Researcher } from "@/core/types";
import { UserFormData, UserUpdateFormData } from "../validators";

type AnyUserEntity = (Researcher | Participant | HealthProfessional) & {
  role: SystemRoles;
};
